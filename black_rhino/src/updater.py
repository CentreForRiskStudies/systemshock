...
#	from environment import Environment
	...
	def do_update_phase1(self,  environment,   active_banks,  time,  debug):
		...
		for bank in active_banks:
			...
			bank.check_solvency(state.requiredCapitalRatio,  debug,  time)
	#-------------------------------------------------------------------------
	...
	def do_update_phase3(self,  environment,  active_banks,  time,  debug):
		...
		for bank in active_banks:
			...
			bank.liquidate_assets(environment.initial_assets,  current_assets,  state.liquidationDiscountFactor,  state.requiredCapitalRatio,  debug,  time)
