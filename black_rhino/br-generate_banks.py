...
if __name__ == '__main__':
	...
	for i in range(numBanks):
		...
		text = text + "    <parameter type='changing' name='pBank' value='" + "0.95" + "' validity='0-1000'></parameter>\n"
		text = text + "    <parameter type='changing' name='rhoBank' value='" + "0.09" + "' validity='0-1000'></parameter>\n"
		...
		text = text + "    <parameter type='changing' name='gammaBank' value='0.8' validity='0-1000'></parameter>\n"
		text = text + "</bank>\n"
		outFile.write(text)
		outFile.close()
