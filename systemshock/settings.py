# Django settings for systemshock PROJECT
# used to set up the admin interface
...
INSTALLED_APPS = (
    ...
    #to set up CMS tables in public schema
    'weblib',
    # photologue - if running syncdb you need to comment this line out
    #'photologue',
    'south',
    # comment framework
